    ...
    try:
        ...
        try:
            ...
            def process_chunk(index, offset):
                query = f"(SELECT * FROM {full_table_name} LIMIT {chunk_size} OFFSET {offset}) AS chunked"
...
# meta_df = meta_df.filter((col("schema_name") == 'analytics_logistics') & (col("table_name") == "exp_subos_adj_nm_rto_adj_sk_2"))
